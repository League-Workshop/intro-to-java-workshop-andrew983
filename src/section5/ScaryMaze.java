...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("bread.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		int bground = -1;
		//8.ouse falls off the path (if it is on the background)
		if(mouseColor != bground) {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("bread2.wav"));
